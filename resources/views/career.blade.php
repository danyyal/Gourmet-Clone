...
<nav class=" breadcrumb about-nav h-5 d-flex w-100 justify-content-between "> 
    <h4 class="breadcrumb pl-5">CAREER</h4>
...
<div class="container mx-auto row">
   <div class="contact-form col-md-6 col-12 ">
       <h3 class="display-5">Career</h3>
        <form class="d-flex flex-column ">
        <input type="text" placeholder="Name" class="form-control form-control-lg">  <br>
        <input type="email" placeholder="Email" class="form-control form-control-lg">  <br>
        <input type="text" placeholder="Applying for" class="form-control form-control-lg"><br>         
        <input type="file"  class="file-width" >
        <small>no file choosen</small>  
        <input type="text" class="form-control form-control-lg">  <br>
        <textarea cols="30" rows="7"></textarea><br>
        <button class="btn rounded field-button" type="submit">Send</button> 
        </form>
   </div>
